...
Welcome to the GitOps Repository Documentation. This repository is designed to manage multiple Kubernetes clusters using Flux CD, Cilium, Kustomize, and Helm. Below, you'll find a structured overview of the clusters, applications, and infrastructure components managed within this repository.

---

## Table of Contents

### [livingroom-pi](livingroom-pi/overview.md)
- **Cluster Overview**: [Cluster overview](livingroom-pi/overview.md)
...
### [nas](nas/overview.md)
- **Cluster Overview**: [Cluster overview](nas/overview.md)
...
### [tpi-1](tpi-1/overview.md)
- **Cluster Overview**: [Cluster overview](tpi-1/overview.md)
